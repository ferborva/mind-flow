...
if (digest(issuedBytes) !== "sha256:bc230310d6edb9814ef350dd58f683ca26f7fd60a9a43cd48c1ed2aacf995053") {
...
export async function inspectNeroRows(rows, forecast) {
  ...
  for await (const row of rows) {
    ...
    if (row[2] === "101" && row[4] === "5311" && date === "2026-10-15") selected.push(row);
  }
