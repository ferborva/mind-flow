...
import { checkNeroFirstPresence, inspectNeroRows, requireNeroResolutionAdmission, prepareNeroResolutionEvidence, admitNeroResolution } from "../round-08-nero/resolution-intake.mjs";
import { evaluateForecastCohort } from "../../lib/evaluation.mjs";
import { singleMemberZip } from "./support/nero-zip-fixture.mjs";

const json = (name) => JSON.parse(readFileSync(new URL(`../round-08-nero/${name}`, import.meta.url)));
