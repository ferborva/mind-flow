...
function assessResolverArtifacts(protocol, forecast, sources, errors) {
  ...
  const allowed = new Set(["forecasts/prospective-pilot/round-09-nero/resolver.mts",
    "forecasts/prospective-pilot/round-09-nero/basis.mts", "dashboard/tools/build-nero-baseline.mjs",
    "forecasts/prospective-pilot/tests/round-09-nero-corrected.test.mjs",
    "forecasts/prospective-pilot/round-09-nero-corrected/target-policy.mjs",
    "forecasts/prospective-pilot/round-09-nero-corrected/candidate.mts",
    "forecasts/prospective-pilot/operational-clock.mjs",
    "forecasts/prospective-pilot/tests/operational-clock.test.mjs",
  ...
  if (!parameters?.dependencies || typeof parameters.dependencies !== "object" || Array.isArray(parameters.dependencies)) {
    ...
    if (protocol?.target?.resolution_source_uri === "https://www.jobsandskills.gov.au/data/nero" &&
        (parameters.occupation_code !== "5311" || parameters.sa4_code !== "102" || parameters.date !== "2026-10-15" ||
         parameters.count_baseline !== 3092 || !isDeepStrictEqual(Object.keys(parameters.dependencies).sort(), [...allowed].sort()))) {
...
export function assessFutureIssuanceBinding({
  ...
  try {
    ...
    assertNeroTargetConsistency(parsedForecast.document, parsedProtocol.document,
    ...
    errors.push(issue("NERO_NATIVE_TARGET_PROSE_CONFLICT", "/target", error.message));
  }
