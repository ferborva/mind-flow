// Round 09 edition: original Round 08 adapter remains sealed and unchanged.
// Only the native NERO target and dependency allowlist differ; existing contracts remain in force.
...
function assessResolverArtifacts(protocol, forecast, sources, errors) {
  ...
  const allowed = new Set(["forecasts/prospective-pilot/round-09-nero/resolver.mts",
    ...
    "forecasts/prospective-pilot/tests/round-09-nero.test.mjs",
