...
title: Title
type: draft
status: drafting       # drafting | review | ready
size: short            # short | medium | long
themes: []
sources: [capture-id, ...]
created: YYYY-MM-DD
updated: YYYY-MM-DD
...
Open with something concrete. A moment, a specific failure, a thing someone
...
Delete this section when the draft moves to `posts/`.
...
- [ ] **Gaps.** No `GAP` markers left. Any that could not be closed are in the
      backlog and the piece works without them.
- [ ] **Ending.** It lands. It does not summarise what it just said.
