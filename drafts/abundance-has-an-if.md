...
- Every abundance claim I hear has the same shape: **verb + fill in the blank.**
  You will be able to learn anything, cure anything, build anything.
...
I have been listening to a lot of abundance conversations, and I have been
giving this a long think. Every time, we come back to the same questions. What
does abundance really look like? How do we transition to it? How do we minimise
the damage on the way? Because we really do want this world, that part is not in
dispute.

The framing that interests me most is extreme agency. You will be able to do
anything. You will be able to access anything.

Listen to the shape of it for long enough and a pattern falls out:

> You can do, fill in the blank. You can learn, fill in the blank. You will be
> able to cure, fill in the blank. You will be able to discover, fill in the
> blank.

**The structure of the promised future is: everyone can, a verb, fill in the
blank.** And inside that structure it all sounds great, because it is a world of
promise. I can learn Chinese. I can learn to swim. I can learn to roller skate.
All well and fine.

## ⚠️ The half of the sentence nobody finishes

Here is what I am not hearing anyone talk about, and it is the reason I wanted
to write this down.

**That pattern has a corollary. There is a part that follows, and it is the most
interesting part, and it is exactly where the conversation keeps getting stuck.**

> It should be verb, plus fill in the blank, plus **if**.

We live in a world of conditions. Today, you can buy anything. And anything
really does mean anything. **If.**

| The promise | The conditions we never say out loud |
|---|---|
| You can buy anything | if you have enough money · if there is stock · if you are close enough to the stock to get your hands on it · if a supply chain can reach you |
| ...and depending where you live | if it is legal there · if you are old enough · if you hold the certificate that lets you possess it |

Think about guns in Spain. Perfectly ordinary object in one country, a long
paperwork trail in another.

Now run the abundance version of the same sentence:

> I will be able to heal all my pains - **if** I have the money to request the
> service, **and** I have access to the cure, **and** I live in a country where
> it is legal, **and** where it is produced, **and** it reaches me at a price my
> pocket can take.

**That is the same list with the nouns swapped.** The technology changed. The
conditional structure did not move an inch. I want to call this thing **the
...
<!-- NOTE: he raised an exodus from Earth here, new countries on the moon or
     ...
     public draft because it was half-formed. Possibly its own piece. -->

## 🧮 If people stop working, how does the money reach them?

Money goes to people who produce something of value to someone. So either people
produce, or money has to flow to them some other way. In a world where people
don't work but money still has to circulate, something has to put money in their
hands, so it can flow back to the businesses making the goods.
...
<!-- NOTE: his list also included sexual services, said flatly among the others.
     Held out of the public draft pending his call, not sanitised from the
     capture. Say the word and it goes back in. -->

**But those services have to be paid for, and the people enjoying them need
something to pay with.** And these sit high in the Maslow pyramid: the house,
...
**What should they be doing with those profits?** One company alone may not move
the needle. Put the collective profits of the top of the S&P 500 on the table
and it is a different conversation.

I know the answer they will give, because it is a reasonable one. We reinvest, we
expand, we push the frontier, so the money can't come back to consumers yet. And
we are returning it to society anyway: new businesses, new data centres, new
power plants, new jobs. Or we lower our prices because we are more efficient.

That holds. **For now.** And "for now" is doing a lot of work in that sentence.

Which brings me to the question underneath all of it. How much money can a
company accrue? And from an owner's point of view, how much can one person
accrue?

I know this opens the door to socialist arguments, and I want to be fair to the
other side: that money is well earned by the founders of a massive business. It
is theirs by right. Should anyone be able to take it away, or cap it?

I don't have a settled answer. But I think there is a more useful way in.

## 📏 Make it a threshold, not a utopia

When Musk says working will be optional, here is the thing: **that is already
true. For a very small number of people.** They have accrued enough that the
wealth generates value on its own. Park it in a bank account, account for
inflation, live above average for a hundred years, and it does not run out.

I am middle upper class and well placed. I do not have endless luxuries, I work
every day, I cannot hypothetically retire whenever I like. But I can picture the
...
It is far too easy to say you can have anything. **No one can have anything.**

Everything is limited. Materials are limited. Atoms are limited. Energy is
limited and stays limited for years yet. Compute is limited. Time is very
limited. Even if we cure everything, the number of cures is limited.

And some scarcity is not a supply problem waiting to be solved. The number of
bottles of a Cabernet Sauvignon special reserve from fifteen or twenty years ago
is fixed. You cannot make more of those. No quantity of intelligence or energy
produces another one.

Which means the honest version of the goal is not "everyone can have anything".
It is a floor: what is the base quality of life we guarantee? I will be first to
...
Not rhetorical. I genuinely want these argued:

1. **Is there a version of abundance that survives the ifs?** Or does every
   promise collapse into "if you can pay, and if your government allows it"?
2. **How much is enough for one person?** If working optional is already real for
   a few, what is the number, and how do we grow the count?
3. **What is the floor?** Not what everyone can have. What everyone is guaranteed.
4. **Why are we still framing this as beating China** when the conditions we are
   describing are global?
5. **What should the top of the S&P 500 do with the profits?** Not what should
   they be forced to do. What should they choose to do.

Food for thought. Tell me where I have got this wrong.
