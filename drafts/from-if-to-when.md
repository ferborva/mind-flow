...
This piece is a different class from `abundance-has-an-if.md`.

That one was his substance, ghostwritten. Every claim traced to a capture.

This one is a COMMISSIONED PROPOSAL. He asked for a transition design that does
not exist in any capture, so most of the structure below is mine, built on his
foundation and the red team. It is written in his voice because he intends to
publish it, but he has not yet endorsed the specifics.

His, verified:
  - the verb + blank + if equation, and the condition lists
  - money does not disappear; conditions are national; everything is limited
...
## 🧩 Where the last piece got to

Quick recap for anyone who missed it. Every abundance claim has the shape
**verb + fill in the blank**. You will be able to learn anything, cure anything,
build anything. And the sentence is incomplete, because the real structure is
...
Here is what changed my mind about how to think about the transition.

Between 1780 and 1840 in Britain, output per worker rose **46%**. Real wages rose
**12%**. The profit rate **doubled**, and profit's share of national income
expanded at the expense of labour.

Robert Allen called it **Engels' Pause**, after Engels' account of the condition
...
- **Business:** shifts from selling to provisioning. The zero-cost tier starts
...
Same as last time. Not rhetorical.
...
STATUS: commissioned proposal. Needs his sign-off section by section, not just a
read-through. The provenance warning at the top of this file explains why.
...
- Which of his own points he now considers weak. He said the red team made him
  reflect and never said which. That answer would sharpen the correction section.
-->
