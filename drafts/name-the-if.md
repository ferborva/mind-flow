...
id: name-the-if
title: Name the If
subtitle: The half of the abundance sentence we never finish, and how to use it
type: draft
status: drafting
size: medium
themes: [abundance]
...
Verb, plus fill in the blank. Inside that structure everything sounds great,
because it is a world of promise.
...
## ⚖️ "But everything is conditional"

The strongest objection to all of this, and it is a fair one: of course there
are conditions. There are conditions in every sentence ever spoken, including *I
can walk to the shop*. A lens that applies to everything tells you nothing.
...
|---|---|
| **Price** - _can you pay_ | Is the cost inside this person's reach, not the average person's |
| **Permission** - _is it allowed_ | Legal for you, here, from that provider, at your age, with your paperwork |
...
provide it" is a decision that can be reversed on a quarterly earnings call.
Worth splitting the moment a promise depends on somebody's continued generosity.
...
## 🔁 And it runs on the supplier too

One more turn, because this is what stops the frame being a complaint.

Say we solve it with free AI compute for everyone, beamed from orbit, direct to
device. Wonderful. Now run the same sentence on whoever has to provide it:

> **That company will be able to offer endless free compute - if...**

And off we go again: launch cost, power, spectrum and landing rights country by
country, a terminal somebody has to own, and someone carrying the loss until one
...
not discussing the future, we are admiring it.

---

## 👉 What I would love you to do with it
