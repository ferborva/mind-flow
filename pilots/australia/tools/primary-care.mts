...
export function deriveMeasurements() {
  ...
  const bindingEstimate = series.find(s => s.id === 'gp-cost-delay').points.find((p: any) => p.geography === 'NSW' && p.period === '2024-25').value;
